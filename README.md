...
wget -P ~/faugus-launcher https://github.com/Faugus/faugus-launcher/releases/download/v.1.1-22/faugus-launcher_1.1-22_amd64.deb
wget -P ~/faugus-launcher https://github.com/Faugus/faugus-launcher/releases/download/v.1.1-22/python3-umu-launcher_1.1.4-1_amd64.deb
wget -P ~/faugus-launcher https://github.com/Faugus/faugus-launcher/releases/download/v.1.1-22/umu-launcher_1.1.4-1_all.deb
...
Download <a href="https://github.com/Faugus/faugus-launcher/releases/download/v.1.1-22/faugus-launcher-0.1.16.flatpak">faugus-launcher-0.1.16.flatpak</a> and run:
```
flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo
flatpak install faugus-launcher-0.1.16.flatpak
```
```
# Optional tools
