...
Download <a href="https://github.com/Faugus/faugus-launcher/releases/download/1.6.2/faugus-launcher-0.6.2-2.flatpak">faugus-launcher-0.6.2-2.flatpak</a> and run:
```
...
flatpak install -y --user faugus-launcher-0.6.2-2.flatpak
```
