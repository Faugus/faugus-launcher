...
wget -P ~/faugus-launcher https://github.com/Faugus/faugus-launcher/releases/download/1.18.11/faugus-launcher_1.18.11-1_all.deb
...
### Dependencies:
```
meson ninja pygobject requests pillow vdf psutil pygame imagemagick icoextract libayatana-appindicator libcanberra
```
