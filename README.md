...
wget -P ~/faugus-launcher https://github.com/Faugus/faugus-launcher/releases/download/1.2.2/faugus-launcher_1.2.2-3_amd64.deb
...
Download <a href="https://github.com/Faugus/faugus-launcher/releases/download/1.2.2/faugus-launcher-0.2.2-3.flatpak">faugus-launcher-0.2.2-3.flatpak</a> and run:
```
flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo
flatpak install faugus-launcher-0.2.2-3.flatpak
```
```
# Optional tools
